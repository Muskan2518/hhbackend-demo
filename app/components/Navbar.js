        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className="bg-gradient-to-r from-primary to-brand-green text-white px-5 py-2.5 rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 animate-pulse-glow cursor-pointer"
            >
              Get the App
            </button>
          </div>
          ...
          <div className="pb-4 border-t border-gray-100">
            <div className="flex flex-col gap-1 pt-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-primary to-brand-green text-white px-5 py-2.5 rounded-full font-semibold text-center mt-2 hover:scale-105 transition-transform cursor-pointer"
              >
                Get the App
              </button>
            </div>
