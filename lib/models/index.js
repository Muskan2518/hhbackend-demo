...
Advertiser.hasMany(User, { foreignKey: 'advertiserId', as: 'referredUsers' });
User.belongsTo(Advertiser, { foreignKey: 'advertiserId', as: 'advertiser' });

module.exports = { sequelize, User, Dependent, Provider, Service, ServiceRequest, Invoice, Advertiser };
